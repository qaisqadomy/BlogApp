...
public class TestHelper
{
    ...
    public static Comment Comment1() => new() { Id=1,Body = "Comment 1", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, AuthorId = 1 };

    public static Comment Comment2() => new() { Id=2, Body = "Comment 2", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, AuthorId = 2 };
